<template>
	<div class="w-full flex justify-around content-center pt-8 pb-4 gap-4">
		<!-- Προηγούμενος -->
		<RouterLink v-if="currentId > 1"
			:to="{ path: '/character/' + (currentId - 1), query: { page: pageFromQuery } }">
			<button class="mt-6 bg-lime-400 text-fuchsia-800 hover:ring hover:ring-lime-500 hover:shadow-md hover:shadow-lime-500 
