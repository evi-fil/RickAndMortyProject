<template>
	<div class="min-h-screen px-4">
		...
		<div class="grid grid-cols-none justify-items-center-safe pt-8 gap-8
			...
			<div v-for="character in characters" :key="character.id" class="bg-gradient-to-t from-violet-900 to-fuchsia-800 text-violet-200 py-6 rounded-xl
                  shadow-lg w-72 hover:ring hover:ring-lime-500 hover:shadow-lime-500
