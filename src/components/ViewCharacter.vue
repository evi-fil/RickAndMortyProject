  ...
  <div class="min-h-screen px-6 py-16">
    <div class="pl-122 pb-8">
      <RouterLink :to="{ path: '/all-characters', query: { page: pageFromQuery } }">
        <button
          class="group mt-4 bg-lime-400 text-fuchsia-800 hover:ring hover:ring-lime-500 hover:shadow-md 
    ...
    <div class="bg-gradient-to-r from-fuchsia-800 from-10% to-violet-900 to-100% text-violet-200 rounded-xl shadow-2xl 
    p-6 flex flex-col md:flex-row gap-8 max-w-4xl w-full mx-auto">
      <img
        :src="character.image"
